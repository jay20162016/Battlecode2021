...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        if (rc.getInfluence()>10000){
          ...
          influence = 1000;
            ...
            if (rc.getInfluence()>3000 && rc.getTeamVotes()<751){
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    static void runPolitician() throws GameActionException {
      ...
      for (RobotInfo robot : rc.senseNearbyRobots(sensorRadius, Team.NEUTRAL)) {
        ...
        for (RobotInfo robot : rc.senseNearbyRobots(1, me)) {
          if (robot.type == RobotType.SLANDERER){
            Game.tryMove(rc, rc.getLocation().directionTo(robot.getLocation()));
          }
        }
        ...
        if (backing > 7) Game.tryMove(rc, Game.randomDirection(0,0.2,0.11,0.2,0,0.2,0.09,0.2));
        for (RobotInfo robot : rc.senseNearbyRobots(sensorRadius, me)) {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    static void runSlanderer() throws GameActionException {
      ...
      if (Math.random()<0.3) Game.tryMove(rc, Game.randomDirection(0,0.2,0.11,0.2,0,0.2,0.09,0.2));
